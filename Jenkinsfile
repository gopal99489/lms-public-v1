pipeline {
    ...
    stages {
        ...
        stage('Test') {
            steps {
                echo 'Testing..'
                sh 'cd webapp && sudo docker container run --rm -e SONAR_HOST_URL="http://18.61.28.246:9000" -e SONAR_LOGIN="sqp_3435dfd3859e4132870b355c939c6b42e59f0061" --volume ".:/usr/src" sonarsource/sonar-scanner-cli -Dsonar.projectKey=lmsproject/'
            }
        }
        stage('Releasing') {
            steps {
